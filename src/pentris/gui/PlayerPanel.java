...
public class PlayerPanel extends GuiPanel {
    ...
    public void update() {
        ...
        if (main.isOver()) {
            ...
            if (gameOverOverlayHeight == 0) {
                Game.updateHighscores(Game.PLAYER_HIGHSCORES, main.getScore());
            }
    ...
    public void render(Graphics2D g2) {
        ...
        g2.drawString(Game.getCurrenctHighscore(Game.PLAYER_HIGHSCORES)+"", Main.boardX+Main.cellSize*5+5, Main.boardY+Main.cellSize*5);
        if (main.isOver()) {
            g2.setColor(new Color(200, 200, 200));
